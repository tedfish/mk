          ...
          >
            ...
            <Grid item>
              <Autocomplete
                ...
                freeSolo
                renderInput={(params) => (
                  <TextField {...params} label="Browse Menus" variant="outlined" size="medium" />
                )}
              />
              <Dialog open={open} onClose={handleClose} aria-labelledby="form-dialog-title">
                <form onSubmit={handleSubmit}>
                  <DialogTitle id="form-dialog-title">Add a new menu</DialogTitle>
                  <DialogContent>
                    <DialogContentText>
                      Did you miss any menus in our list? Please, add it!
                    </DialogContentText>
                    <TextField
                      margin="dense"
                      id="name"
